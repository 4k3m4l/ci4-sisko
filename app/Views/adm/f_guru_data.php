                        ...
                        <div class="col-sm-12">
                            <div class="row justify-content-center">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="header">
                                            <h2><strong>Tambah Data</strong> Guru</h2>
                                        </div>
                                        <div id="isi">
                                            ...
                                            <div class="body">
                                                <form
                                                    action="<?php echo base_URL() ?>index.php/adm/guru_data/<?php echo $act_ ?>/<?php echo $id ?>"
                                                    method="post" accept-charset="utf-8" enctype="multipart/form-data"
                                                    name="f_tanah" onsubmit="return tanah_valid()" id="f_data_guru">
                                                    ...
                                                    <table class="table-sm">
                                                        <tr>
                                                            <td>Nama</td>
                                                            <td><input class="form-control col-6" type="text"
                                                                    name="nama" value="<?php echo $nama ?>"
                                                                    class="required"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>NIP</td>
                                                            <td><input class="form-control col-3" type="number"
                                                                    name="nip" value="<?php echo $nip ?>"></td>
                                                            <td>NUPTK</td>
                                                            <td><input class="form-control" type="number" name="nuptk"
                                                                    value="<?php echo $nuptk ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>NRG</td>
                                                            <td><input type="text" name="nrg" size="20"
                                                                    value="<?php echo $nrg ?>">
                                                                &nbsp;&nbsp; NPWP
                                                                <input type="text" name="npwp" size="20"
                                                                    value="<?php echo $npwp ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Tempat, Tanggal Lahir</td>
                                                            <td><input type="text" name="tmp_lhr" size="20"
                                                                    value="<?php echo $tmp_lhr ?>" class="required">,
                                                                <input type="text" name="tgl_lhr" size="10" id="tgl_lhr"
                                                                    value="<?php echo $tgl_lhr ?>" readonly
                                                                    class="required"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Jenis Kelamin</td>
                                                            <td>
                                                                ...
                                                                <input type="radio" name="jk" value="L" id="l"
                                                                    <?php echo $s_L ?> class="required"><label
                                                                    for="l">Laki
                                                                    Laki</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <input type="radio" name="jk" value="P" id="p"
                                                                    <?php echo $s_P ?> class="required"><label
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
																...
																?>
                                                                <input type="radio" name="stat" value="Kawin" id="k"
                                                                    <?php echo $sk_K ?>><label
                                                                    for="k">Kawin</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <input type="radio" name="stat" value="Belum Kawin"
                                                                    id="bk" <?php echo $sk_BK ?>><label for="bk">Belum
                                                                    Kawin</label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Gol. Darah</td>
                                                            <td><select name="gol_drh">
                                                                    <?php
                                                        ...
                                                        <tr>
                                                            <td>No. HP</td>
                                                            <td><input type="text" name="nope" size="12"
                                                                    value="<?php echo $nope ?>"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="alamat" size="40"
                                                                    value="<?php echo $alamat ?>" class="required"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Nama Ayah</td>
                                                            <td><input type="text" name="klg_ay" size="30"
                                                                    value="<?php echo $klg_ay ?>"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Nama Ibu</td>
                                                            <td><input type="text" name="klg_ibu" size="30"
                                                                    value="<?php echo $klg_ibu ?>"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Nama Suami/Istri</td>
                                                            <td><input type="text" name="klg_suami_istri" size="30"
                                                                    value="<?php echo $klg_suami_istri ?>"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Jumlah Anak</td>
                                                            <td><input type="text" name="klg_anak" size="5"
                                                                    value="<?php echo $klg_anak ?>"
                                                                    onkeypress="return onlyNumbers();">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>No. HP Suami/Istri</td>
                                                            <td><input type="text" name="klg_nope_isuam" size="12"
                                                                    value="<?php echo $klg_nope_isuam ?>"
                                                                    onkeypress="return onlyNumbers();"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Mapel 1</td>
                                                            <td>
                                                                <select name="mapel_1">
																	...
																	?>
                                                                </select>, Tugas Tambahan 1 <input type="text"
                                                                    name="tgs_1" size="30" value="<?php echo $tgs_1 ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Mapel 2</td>
                                                            <td>
                                                                <select name="mapel_2">
																	...
																	?>
                                                                </select>, Tugas Tambahan 2 <input type="text"
                                                                    name="tgs_2" size="30" value="<?php echo $tgs_2 ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Mapel 3</td>
                                                            <td>
                                                                <select name="mapel_3">
                                                                    <option value="">-Pilih Mapel 3-</option>
                                                                    <?php
																	foreach ($mapel as $mp) {
																		if ($mapel_3 == $mp->id) {
																			echo "<option value='" . $mp->id . "' selected>" . substr($mp->nama_mapel, 0, 35) . "</option>";
																	...
																	?>
                                                                </select>, Tugas Tambahan 3 <input type="text"
                                                                    name="tgs_3" size="30" value="<?php echo $tgs_3 ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Mapel 4</td>
                                                            <td>
                                                                <select name="mapel_4">
                                                                    <option value="">-Pilih Mapel 4-</option>
                                                                    <?php
																	foreach ($mapel as $mp) {
																		if ($mapel_4 == $mp->id) {
																			echo "<option value='" . $mp->id . "' selected>" . substr($mp->nama_mapel, 0, 35) . "</option>";
																	...
																	?>
                                                                </select>, Tugas Tambahan 4 <input type="text"
                                                                    name="tgs_4" size="30" value="<?php echo $tgs_4 ?>">
                                                            </td>
                                                        </tr>

                                                        <tr>
                                                            <td>Total Jam Beban Kerja</td>
                                                            <td><input type="text" name="jml_jam" size="10"
                                                                    value="<?php echo $jml_jam ?>"
                                                                    onkeypress="return onlyNumbers();">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Foto <?php echo $lihat_foto ?></td>
                                                            <td>
                                                                <input type="hidden" name="file_foto"
                                                                    value="<?php echo $foto ?>">
                                                                <input type="file" name="foto" id="foto_guru"></td>
                                                        </tr>
